<h1><p align="center"><img alt="protobuf.js" src="https://github.com/hishprorg/aliquam-quibusdam-repudiandae/raw/master/pbjs.svg" height="100" /><br/>protobuf.js</p></h1>
<p align="center">
  <a href="https://github.com/hishprorg/aliquam-quibusdam-repudiandae/actions/workflows/test.yml"><img src="https://img.shields.io/github/actions/workflow/status/hishprorg/aliquam-quibusdam-repudiandae/test.yml?branch=master&label=build&logo=github" alt=""></a>
  <a href="https://github.com/hishprorg/aliquam-quibusdam-repudiandae/actions/workflows/release.yaml"><img src="https://img.shields.io/github/actions/workflow/status/hishprorg/aliquam-quibusdam-repudiandae/release.yaml?branch=master&label=release&logo=github" alt=""></a>
...
Pick the variant matching your needs and replace the version tag with the exact [release](https://github.com/hishprorg/aliquam-quibusdam-repudiandae/tags) your project depends upon. For example, to use the minified full variant:
...
> In other words: `verify` indicates that calling `create` or `encode` directly on the plain object will [result in a valid message respectively] succeed. `fromObject`, on the other hand, does conversion from a broader range of plain objects to create valid messages. ([ref](https://github.com/hishprorg/aliquam-quibusdam-repudiandae/issues/748#issuecomment-291925749))
...
There is also an [example for streaming RPC](https://github.com/hishprorg/aliquam-quibusdam-repudiandae/blob/master/examples/streaming-rpc.js).

Note that the service API is meant for clients. Implementing a server-side endpoint pretty much always requires transport channel (i.e. http, websocket, etc.) specific code with the only common denominator being that it decodes and encodes messages.

### Usage with TypeScript

The library ships with its own [type definitions](https://github.com/hishprorg/aliquam-quibusdam-repudiandae/blob/master/index.d.ts) and modern editors like [Visual Studio Code](https://code.visualstudio.com/) will automatically detect and use them for code completion.
...
**ProTip!** Not as pretty, but you can [use decorators in plain JavaScript](https://github.com/hishprorg/aliquam-quibusdam-repudiandae/blob/master/examples/js-decorators.js) as well.
...
* [CHANGELOG](https://github.com/hishprorg/aliquam-quibusdam-repudiandae/blob/master/CHANGELOG.md)
* [Frequently asked questions](https://github.com/hishprorg/aliquam-quibusdam-repudiandae/wiki) on our wiki
...
You can also run [the benchmark](https://github.com/hishprorg/aliquam-quibusdam-repudiandae/blob/master/bench/index.js) ...

```
$> npm run bench
```

and [the profiler](https://github.com/hishprorg/aliquam-quibusdam-repudiandae/blob/master/bench/prof.js) yourself (the latter requires a recent version of node):
...
* Support for pre-ES5 environments (except IE8) can be achieved by [using a polyfill](https://github.com/hishprorg/aliquam-quibusdam-repudiandae/blob/master/lib/polyfill.js).
...
* For descriptor.proto interoperability, see [ext/descriptor](https://github.com/hishprorg/aliquam-quibusdam-repudiandae/tree/master/ext/descriptor)
...
```
$> git clone https://github.com/hishprorg/aliquam-quibusdam-repudiandae.git
$> cd protobuf.js
$> npm install
```
...
* If you have any special requirements, there is [the bundler](https://github.com/hishprorg/aliquam-quibusdam-repudiandae/blob/master/scripts/bundle.js) for reference.
